...
class DataInspectorPlugin implements Plugin<Project> {
  ...
  void apply(Project project) {
    ...
    project.dependencies {
      debugCompile 'com.github.xfumihiro.data-inspector:data-inspector-runtime:0.1.0'
      ...
      void beforeResolve(ResolvableDependencies resolvableDependencies) {
        if (project.android.compileSdkVersion == 'android-23') {
          project.dependencies
              ...
              'com.github.xfumihiro.data-inspector:data-inspector-aspect-v23:0.1.0'))
        } else {
          project.dependencies
              .add('debugCompile', project.dependencies.create(
              'com.github.xfumihiro.data-inspector:data-inspector-aspect:0.1.0'))
        }
      }
